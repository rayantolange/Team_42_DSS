...
export default function QueryPage() {
  ...
  return (
    <div className="grid gap-6 lg:grid-cols-[minmax(0,1fr)_300px]">
      <div className="flex flex-col gap-4">
        {!hasActivity ? (
          <div className="relative overflow-hidden rounded-3xl bg-navy-gradient p-8 shadow-popover sm:p-12">
            ...
            <div className="relative z-10 flex flex-col items-center gap-4 text-center animate-fade-in">
              ...
              <p className="max-w-md text-sm text-white/70">
                Access institutional knowledge and decision models with natural
                language.
              </p>
            </div>
          ...
          <>
            ...
            />
            <div ref={bottomRef} />
            <div className="sticky bottom-0 z-10 -mx-4 bg-muted/20 px-4 pb-4 pt-2 backdrop-blur-sm sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
              <QueryBuilder
                onSubmit={handleSubmit}
                isSubmitting={submitQuery.isPending}
              />
      ...
      <div className="hidden lg:sticky lg:top-6 lg:block lg:h-[calc(100vh-7.5rem)]">
        <QueryHistoryPanel
