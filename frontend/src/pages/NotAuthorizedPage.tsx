...
export default function NotAuthorizedPage() {
  ...
  const homeLabel = isAdmin ? "Return to Admin Panel" : "Return to Dashboard";
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center gap-4 bg-muted/20 p-6 text-center">
      ...
      <p className="max-w-md text-muted-foreground">
        Your account role doesn't include permission to view this section. If
        you believe this is a mistake, contact your system administrator.
      </p>
